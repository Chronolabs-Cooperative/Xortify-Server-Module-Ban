 ...
 *
 */
class banFormSelectCardtype extends XoopsFormElement
{
    /**
     * Options
     *
    ...
    function __construct($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$categorieshandler =& xoops_getmodulehandler('members','ban');
		$cardtypes = $categorieshandler->getCardTypes();
		foreach($cardtypes as $key => $type)
			$this->addOption($key, $type);
