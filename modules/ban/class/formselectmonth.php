 ...
 *
 */
class banFormSelectMonth extends XoopsFormElement
{
    /**
     * Options
     *
    ...
    function __construct($caption, $name, $value = null, $size = 1, $multiple = false)
    {
		...
		$this->addOption('01', 'January (01)');
		$this->addOption('02', 'Feburary (02)');
		$this->addOption('03', 'March (03)');
		$this->addOption('04', 'April (04)');
		$this->addOption('05', 'May (05)');
		$this->addOption('06', 'June (06)');
		$this->addOption('07', 'July (07)');
		$this->addOption('08', 'August (08)');
		$this->addOption('09', 'September (09)');
		$this->addOption('10', 'October (10)');
		$this->addOption('11', 'November (11)');
		$this->addOption('12', 'December (12)');
